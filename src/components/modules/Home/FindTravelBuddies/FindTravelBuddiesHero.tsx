...
const FindTravelBuddiesHero = ({ cities }: FindTravelBuddiesHeroProps) => {
  return (
    <div className="container mx-auto">
      <div className="bg-linear-to-br from-blue-500 via-teal-500 to-cyan-600 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 text-white overflow-hidden relative w-full  md:h-[70vh] mx-auto">
