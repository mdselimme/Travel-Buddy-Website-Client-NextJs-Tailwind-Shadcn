...
export const getAllTravelPlansForUsers = async ({ search, startDate, travelType, limit, page }: { search?: string, startDate?: string, travelType?: string, limit?: number, page?: number } = {}) => {
    try {
